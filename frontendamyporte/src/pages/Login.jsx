...
export default function Login() {
  ...
  return (                                                                                                                                              
    ...
    <div className="min-h-screen  flex bg-linear-to-b from-[#faf6ef] to-[#f0e5d2] items-center justify-center p-6 ">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
      <motion.div initial={{opacity:0, y:30}} animate={{opacity:1, y:0}} transitions={{duration:0.7}} className="w-full max-w-md bg-white/70 backdrop-blur-xl border border-[#C9A86A]/30 rounded-3xl shadow-2xl p-10 ">
