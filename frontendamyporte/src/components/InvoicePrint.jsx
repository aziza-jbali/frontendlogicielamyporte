  ...
  ({ invoice, datapaiment, client, datainvoice }, ref) => {
    ...
    return (
      <div
        ...
        className="text-sm print:m-0 print:p-[12mm] print:shadow-none print:[print-color-adjust:exact] print:[-webkit-print-color-adjust:exact]"
      >
        <div>
          {/* HEADER */}
          <div className="relative overflow-hidden h-[250px] bg-[#3B2414] rounded-t-3xl">
            ...
            <div className="flex gap-3 mt-8 ml-8">
              <DoorOpen className="w-14 h-14 text-[#fac28e]" />
          ...
          >
            ...
            >
              <div>
                <p className="italic text-sm">FACTURE À :</p>
                <p className="font-bold text-xl text-black">
                  {client.nom || ""}
                </p>
              </div>
              ...
              <div>
                <p className="italic text-sm">CONTACT :</p>
                <p className="font-bold text-xl text-black">
                  {client.numero || ""}
                </p>
              </div>
              ...
              <div>
                <p className="italic text-sm">ADRESSE :</p>
                <p className="font-bold text-xl text-black">
                  {client.adresse || ""}
                </p>
              </div>
          ...
          >
            <div className="text-[#d2b49c] space-y-4">
              ...
              <div
                ...
                "
              >
                <div className="font-bold text-lg">Montant à payer :</div>
                ...
                <div className="font-bold text-lg">Type de paiement :</div>
              ...
              {datapaiment.typepaiement === "acompte" && (
                <div
                  ...
                  "
                >
                  <div className="font-bold text-lg">Acompte :</div>
                  ...
                  <div className="font-bold text-lg">Reste :</div>
